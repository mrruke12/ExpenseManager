<template>
    <header class="p-4 bg-linear-to-b from-emerald-600 to-emerald-400 flex sm:items-center justify-between">
        <router-link to="/">
        ...
        <div class="flex flex-col w-auto sm:w-full sm:flex-row sm:justify-between">
            ...
            <div id="menu" class="w-full hidden sm:flex sm:justify-between">
                <ul>
                ...
                <ul>
                    <li v-if="Authorized" class="flex items-center" @click="Logout(router)">
                    ...
                    <li v-else class="flex items-center" @click="() => router.go('/auth')">
